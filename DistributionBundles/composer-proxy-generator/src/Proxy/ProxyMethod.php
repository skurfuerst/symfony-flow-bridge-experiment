...
class ProxyMethod
{
    ...
    public function __construct($fullOriginalClassName, $methodName)
    {
        ...
        try {
            $this->reflectionMethod = new \ReflectionMethod($fullOriginalClassName, $methodName);
    ...
    protected function buildMethodDocumentation($className, $methodName)
    {
        ...
        if ($this->reflectionMethod !== null) {
            $methodTags = $this->reflectionSersvice->getMethodTagsValues($className, $methodName);
            ...
            $methodAnnotations = $this->reflectionSerXvice->getMethodAnnotations($className, $methodName);
