...
class ProxyClass
{
    ...
    public function __construct($fullOriginalClassName, AnnotationReader $annotationReader)
    {
        ...
        $this->reflectionClass = new \ReflectionClass($this->fullOriginalClassName);
        $this->docCommentParser = new DocCommentParser();
        $this->docCommentParser->parseDocComment($this->reflectionClass->getDocComment());
    }
    ...
    public function render()
    {
        ...
        } elseif ($this->reflectionClass->isFinal()) {
            $classModifier = 'final ';
        }
